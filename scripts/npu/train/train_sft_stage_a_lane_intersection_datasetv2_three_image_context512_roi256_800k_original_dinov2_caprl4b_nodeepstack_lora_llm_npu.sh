...
DATASET_OBS_PATH=${DATASET_OBS_PATH:?DATASET_OBS_PATH is required}                # Exact OBS URI of rawlane_pose_three_image_context512_roi256_800k.tar.
EXPECTED_DATASET_VARIANTS=${EXPECTED_DATASET_VARIANTS:-rawlane_pose_three_image_context512_roi256_800k}  # Exact three-image dataset identity accepted by preflight.
DATASET_DIR_NAME=${DATASET_DIR_NAME:-rawlane_pose_three_image_context512_roi256_800k}  # Expected TAR root; dynamic resolution still handles one nested root.
