...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_intersection_dinov3_nodeepstack_lora_llm}  # SwanLab group name for related runs.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane_intersection,dinov3,qwen3vl8b,nodeepstack,lora,llm_lora,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
...
export RDZV_ID=${RDZV_ID:-sft_phase_a_lane_intersection_dinov3_lora_llm_${RUN_ID}}  # Unique rendezvous id for this distributed run.
