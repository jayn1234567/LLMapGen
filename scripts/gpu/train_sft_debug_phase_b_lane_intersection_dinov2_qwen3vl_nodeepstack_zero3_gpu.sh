...
# SFT Phase B smoke: DINOv2 + Qwen3VL + no DeepStack + ZeRO-3.
# Phase B trains with incoming hints and then runs state-update inference to merge patches.
...
TRAIN_JSONL="data/debug_phase_b_lane_intersection20/train.jsonl"
TEST_JSONL="data/debug_phase_b_lane_intersection20/test.jsonl"
IMAGE_FOLDER="data/av2_patch_256_fullimage_cutflag_test_v2"
OUTPUT_DIR="outputs/sft_debug_phase_b_lane_intersection_dinov2_qwen3vl_nodeepstack_zero3_gpu"
INFER_DIR="${OUTPUT_DIR}/infer_patch_test"
STATE_DIR="${OUTPUT_DIR}/state_update_test"

VERSION="conv_qwen_3_Dinov2_huawei"
STATE_VERSION="conv_qwen_3_Dinov2_huawei"
...
echo "============================================================"
echo "SFT Phase B ZeRO3 debug: DINOv2 + Qwen3VL + no DeepStack"
