...
class Qwen3MultimodalConfig(_Qwen3Config):
    model_type = "qwen3"


class LegacyLlavaQwen3ConfigWrapper(Qwen3MultimodalConfig):
    model_type = "llava_qwen3"


class Qwen3MultimodalModel(LlavaMetaModel, _Qwen3Model):
...
class Qwen3MultimodalForCausalLM(_Qwen3ForCausalLM, LlavaMetaForCausalLM):
    config_class = Qwen3MultimodalConfig

    def __init__(self, config):
        super(_Qwen3ForCausalLM, self).__init__(config)
        self.model = Qwen3MultimodalModel(config)
...
LlavaQwen3ConfigWrapper = Qwen3MultimodalConfig
LlavaQwen3Model = Qwen3MultimodalModel
LlavaQwen3ForCausalLM = Qwen3MultimodalForCausalLM

AutoConfig.register("llava_qwen3", LegacyLlavaQwen3ConfigWrapper)
AutoModelForCausalLM.register(Qwen3MultimodalConfig, Qwen3MultimodalForCausalLM)
