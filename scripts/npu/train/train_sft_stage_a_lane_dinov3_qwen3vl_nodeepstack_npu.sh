...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_dinov3_nodeepstack}             # SwanLab group name for related experiments.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_a_lane_dinov3_qwen3vl8b_nodeepstack}  # SwanLab experiment display name.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane,dinov3,qwen3vl8b,nodeepstack,unimapgen_v9}     # SwanLab comma-separated tags.
