...
CKPT=outputs/qwen_dinov2_map_serialization_av2_partial_state/best.pt
...
python -m unimapgen.eval_opensatmap_official \
  --config configs/qwen_dinov2_map_serialization_av2_partial_state.yaml \
  --prediction_json outputs/qwen_dinov2_map_serialization_av2_partial_state/predictions_state_scan.json \
  --output outputs/qwen_dinov2_map_serialization_av2_partial_state/official_metrics_state_scan.json
