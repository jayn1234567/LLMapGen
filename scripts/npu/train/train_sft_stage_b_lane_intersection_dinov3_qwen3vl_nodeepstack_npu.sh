...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_b_lane_intersection_dinov3_nodeepstack}  # SwanLab group name for related runs.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_b,lane_intersection,dinov3,qwen3vl8b,nodeepstack,from_stage_a,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
...
export RDZV_ID=${RDZV_ID:-sft_phase_b_lane_intersection_dinov3_${RUN_ID}}         # Unique rendezvous id for this distributed run.
