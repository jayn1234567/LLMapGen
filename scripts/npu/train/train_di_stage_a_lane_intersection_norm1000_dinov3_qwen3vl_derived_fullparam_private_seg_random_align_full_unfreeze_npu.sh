...
#
# Warning: Qwen3 8B full-parameter training is memory-heavy even with ZeRO-3.
# For local Ascend smoke tests, start with MAX_STEPS=5.
...
export VISION_ENCODER_LR=${VISION_ENCODER_LR:-2e-6}
