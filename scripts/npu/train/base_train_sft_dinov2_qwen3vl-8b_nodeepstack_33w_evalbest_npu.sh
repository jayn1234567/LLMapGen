...
echo "SwanLab:    ${SWANLAB_ENABLE}, project=${SWANLAB_PROJECT}, group=${SWANLAB_GROUP}, job=${SWANLAB_JOB_TYPE}, exp=${SWANLAB_EXPERIMENT_NAME}, mode=${SWANLAB_MODE}, logdir=${SWANLAB_LOG_DIR}"
echo "SwanLab URL: api=${SWANLAB_API_HOST:-default}, web=${SWANLAB_WEB_HOST:-default}"
echo "============================================================"
...
torchrun \
    ...
    --best_infer_index_vision_tower "${DINOV2_PATH}" \
