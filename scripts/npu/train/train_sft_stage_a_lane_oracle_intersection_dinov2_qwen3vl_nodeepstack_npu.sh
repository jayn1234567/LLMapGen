...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a_oracle_intersection | lane-only centerline conditioned on GT intersections | dinov2 + Qwen3-VL-8B | no DeepStack
...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_oracle_intersection_lane_dinov2_nodeepstack}  # SwanLab group name for related runs.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_a_oracle_intersection_lane_dinov2_qwen3vl8b_nodeepstack}  # SwanLab experiment display name.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a_oracle_intersection,lane,dinov2,qwen3vl8b,nodeepstack,oracle_intersection,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
