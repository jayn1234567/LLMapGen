...
def write_qwen_multimodal_checkpoint_metadata(model, output_dir: str, trainer=None):
    ...
    payload = {
        ...
        "mm_use_view_type_embedding": _cfg_get(config, "mm_use_view_type_embedding"),
        "mm_view_type_embedding_count": _cfg_get(config, "mm_view_type_embedding_count"),
        "mm_view_type_embedding_init_std": _cfg_get(config, "mm_view_type_embedding_init_std"),
