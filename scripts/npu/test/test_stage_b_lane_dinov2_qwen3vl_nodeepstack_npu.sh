...
LOCAL_OUTPUT_ROOT=${LOCAL_OUTPUT_ROOT:-${OBS_CACHE}/test_phase_b_lane_dinov2_output_${RUN_ID}}  # Per-run local inference output root.
...
export RDZV_ID=${RDZV_ID:-test_phase_b_lane_dinov2_${RUN_ID}}                     # Unique rendezvous id for this distributed run.
