...
# Set DATASET_PHASE, MAP_TASK, DATASET_OBS_PATH, DATASET_DIR_NAME and checkpoint
# selection variables as needed. Multiple checkpoints are supported through:
#   CHECKPOINT_OBS_LIST=obs://.../checkpoint-500,obs://.../eval_best_candidates
#   or TRAINED_CHECKPOINT_OBS=obs://.../output CHECKPOINT_NAMES=checkpoint-500,eval_best_candidates
