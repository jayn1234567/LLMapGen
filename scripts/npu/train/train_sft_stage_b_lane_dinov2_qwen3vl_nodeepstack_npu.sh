...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_b_lane_dinov2_nodeepstack}
# SwanLab experiment display name.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_b_lane_dinov2_qwen3vl8b_nodeepstack,from_stage_a}
# SwanLab comma-separated tags.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_b,lane,dinov2,qwen3vl8b,nodeepstack,from_stage_a}
