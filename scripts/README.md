...
- `--tokenizer_use_fast False`: GRPO scripts keep Qwen tokenization on the slow tokenizer path to match SFT and avoid fast-tokenizer compatibility errors in some environments.
