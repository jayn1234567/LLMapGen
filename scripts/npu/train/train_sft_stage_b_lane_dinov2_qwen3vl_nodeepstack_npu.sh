...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_b_lane_dinov2_nodeepstack}             # SwanLab group name for related experiments.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_b,lane,dinov2,qwen3vl8b,nodeepstack,from_stage_a,unimapgen_v9}  # SwanLab comma-separated tags.
