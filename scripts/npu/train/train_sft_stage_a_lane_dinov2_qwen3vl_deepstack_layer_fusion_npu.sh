...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_dinov2_deepstack_layer_fusion}    # SwanLab group name for related runs.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane,dinov2,qwen3vl8b,deepstack,layer_fusion,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
