...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_intersection_dinov2_nodeepstack}  # SwanLab group name for related experiments.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_a_lane_intersection_dinov2_qwen3vl8b_nodeepstack}  # SwanLab experiment display name.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane_intersection,dinov2,qwen3vl8b,nodeepstack,unimapgen_v9}  # SwanLab comma-separated tags.
...
export RDZV_ID=${RDZV_ID:-sft_phase_a_lane_intersection_dinov2_${RUN_ID}}
