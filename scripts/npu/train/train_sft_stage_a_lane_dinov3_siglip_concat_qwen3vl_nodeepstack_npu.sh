...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a | lane-only centerline | DINOv3+SigLIP concat fusion, no DeepStack | Qwen3-VL-derived Qwen3 LLM
...
VISION_RECIPE=dinov3_siglip_concat                                                # Fixed visual architecture recipe encoded by this script name.
...
DINO_V3_TOWER_OBS_PATH=${DINO_V3_TOWER_OBS_PATH:-${MODEL_OBS_PATH}/${DINO_V3_TOWER_NAME}}  # OBS path for the DINOv3 tower used by this recipe.
