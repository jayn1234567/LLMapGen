...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a | lane-only centerline | DINOv2 DeepStack residual injection | Qwen3 text LLM
...
VISION_RECIPE=dinov2_deepstack                                                    # Fixed visual architecture recipe encoded by this script name.
...
DISABLE_DEEPSTACK=${DISABLE_DEEPSTACK:-False}                                     # True disables DeepStack residual injection; False allows it when indexes are set.
