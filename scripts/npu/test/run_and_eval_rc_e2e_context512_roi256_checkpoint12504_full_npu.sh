...
# One command: context512/center-ROI256 inference, repository patch metrics,
# and the untouched original RC E2E all/low/high evaluator.
...
echo "[context512-roi256-e2e] stage 2/3: repository patch metrics"
...
echo "[context512-roi256-e2e] stage 3/3: untouched original RC E2E all/low/high metrics"
...
echo "============================================================"
echo "CONTEXT512-ROI256 CHECKPOINT-12504 FULL E2E EVALUATION COMPLETE"
