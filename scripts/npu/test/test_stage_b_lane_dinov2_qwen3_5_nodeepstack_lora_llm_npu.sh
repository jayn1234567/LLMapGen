...
VISION_TOWER=${VISION_TOWER:-${OBS_CACHE}/checkpoints/${DINO_V2_TOWER_NAME}}
VISION_TOWER_OBS_PATH=${VISION_TOWER_OBS_PATH:-${MODEL_OBS_PATH}/${DINO_V2_TOWER_NAME}}
MM_VISION_TOWER_TYPE=dinov2
INPUT_IMAGE_SIZE=${INPUT_IMAGE_SIZE:-518}
REQUIRED_VISION_TOWERS=("${VISION_TOWER}")

LORA_BASE_CHECKPOINT_OBS_PATH=${LORA_BASE_CHECKPOINT_OBS_PATH:-}
LORA_BASE_CHECKPOINT_PATH=${LORA_BASE_CHECKPOINT_PATH:-}
LORA_BASE_DOWNLOAD_DIR=${LORA_BASE_DOWNLOAD_DIR:-${OBS_CACHE}/lora_base_checkpoint_${RUN_ID}}
