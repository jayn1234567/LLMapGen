...
# Single-node DI-like smoke for the three-image local256 800k recipe.
...
RUN_ID=${RUN_ID:-datasetv2_three_image_local256_800k_dinov2_caprl4b_di_like_smoke_$(date -u +%Y%m%d_%H%M%S)}
SMOKE_ROOT=${SMOKE_ROOT:-${OBS_CACHE}/outputs/datasetv2_three_image_local256_800k_di_like_smoke}
...
DATASET_ARCHIVE_PATH=${DATASET_ARCHIVE_PATH:-${OBS_CACHE}/datasets/rawlane_pose_three_image_local256_800k.tar}
DATASET_EXTRACT_ROOT=${DATASET_EXTRACT_ROOT:-${OBS_CACHE}/datasets/rawlane_pose_three_image_local256_800k_extract}
DATASET_PATH=${DATASET_PATH:-${DATASET_EXTRACT_ROOT}/rawlane_pose_three_image_local256_800k}
...
echo "============================================================"
echo "Dataset V2 three-image local256-800k original-DINOv2 + CapRL-4B LLM-LoRA DI-like smoke"
echo "Repo:             ${REPO_ROOT}"
echo "Python:           ${PYTHON}"
