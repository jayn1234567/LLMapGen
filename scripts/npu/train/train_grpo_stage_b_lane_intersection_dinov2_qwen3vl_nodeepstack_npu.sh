...
LOCAL_OUTPUT_DIR=${LOCAL_OUTPUT_DIR:-${OBS_CACHE}/grpo_phase_b_lane_intersection_dinov2_output_${RUN_ID}}
...
SWANLAB_GROUP=${SWANLAB_GROUP:-grpo_phase_b_lane_intersection_dinov2_nodeepstack}
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-grpo_phase_b_lane_intersection_dinov2_qwen3vl8b_nodeepstack}
SWANLAB_TAGS=${SWANLAB_TAGS:-grpo,phase_b,lane_intersection,dinov2,qwen3vl8b,nodeepstack,vllm-ascend}
