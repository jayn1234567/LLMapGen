...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a | lane-only centerline | DINOv3 DeepStack residual injection | Qwen3 text LLM
...
VISION_RECIPE=dinov3_deepstack                                                    # Fixed visual architecture recipe encoded by this script name.
