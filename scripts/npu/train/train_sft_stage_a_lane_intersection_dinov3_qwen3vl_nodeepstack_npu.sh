...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_intersection_dinov3_nodeepstack}  # SwanLab group name for related experiments.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane_intersection,dinov3,qwen3vl8b,nodeepstack,unimapgen_v9}  # SwanLab comma-separated tags.
