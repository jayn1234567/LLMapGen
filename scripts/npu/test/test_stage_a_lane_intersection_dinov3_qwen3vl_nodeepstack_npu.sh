...
LOCAL_OUTPUT_ROOT=${LOCAL_OUTPUT_ROOT:-${OBS_CACHE}/test_phase_a_lane_intersection_dinov3_output_${RUN_ID}}  # Per-run local inference output root.
...
export RDZV_ID=${RDZV_ID:-test_phase_a_lane_intersection_dinov3_${RUN_ID}}        # Unique rendezvous id for this distributed run.
