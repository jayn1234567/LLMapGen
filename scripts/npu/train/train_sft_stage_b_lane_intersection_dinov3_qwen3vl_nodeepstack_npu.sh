...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_b_lane_intersection_dinov3_nodeepstack}
# SwanLab experiment display name.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_b_lane_intersection_dinov3_qwen3vl8b_nodeepstack,from_stage_a}
# SwanLab comma-separated tags.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_b,lane_intersection,dinov3,qwen3vl8b,nodeepstack,from_stage_a}
...
export RDZV_ID=${RDZV_ID:-sft_phase_b_lane_intersection_dinov3_${RUN_ID}}
