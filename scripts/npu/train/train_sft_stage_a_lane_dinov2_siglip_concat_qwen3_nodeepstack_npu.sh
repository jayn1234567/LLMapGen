...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a | lane-only centerline | DINOv2+SigLIP concat fusion, no DeepStack | Qwen3 text LLM
...
MODEL_FAMILY=qwen3                                                                # LLM family selector: qwen3, qwen3_5, or qwen3vl.
MODEL_LABEL=qwen3                                                                 # Short model label used in run names, logs, and output paths.
...
if [ "${MODEL_FAMILY}" = "qwen3_5" ]; then
  DEFAULT_QWEN_MODEL_NAME=Qwen3.5-4B-Instruct                                     # Default base LLM directory name for this model family.
else
  DEFAULT_QWEN_MODEL_NAME=Qwen3-8B                                                # Default base LLM directory name for this model family.
fi
