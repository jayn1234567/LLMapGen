...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a_oracle_intersection | lane-only centerline conditioned on GT intersections | dinov3 + Qwen3-VL-8B | no DeepStack
...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_oracle_intersection_lane_dinov3_nodeepstack}  # SwanLab group name for related runs.
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_a_oracle_intersection_lane_dinov3_qwen3vl8b_nodeepstack}  # SwanLab experiment display name.
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a_oracle_intersection,lane,dinov3,qwen3vl8b,nodeepstack,oracle_intersection,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
...
export RDZV_ID=${RDZV_ID:-sft_phase_a_lane_dinov3_${RUN_ID}}                      # Unique rendezvous id for this distributed run.
