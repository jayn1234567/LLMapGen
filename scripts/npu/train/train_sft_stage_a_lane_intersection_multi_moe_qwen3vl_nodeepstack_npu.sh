...
# ============================================================
# NPU SFT training
# Fixed recipe: phase_a | lane+intersection | DINOv2+DINOv3 token-router MoE, no DeepStack | Qwen3-VL-derived Qwen3 LLM
...
VISION_RECIPE=multi_moe                                                           # Fixed visual architecture recipe encoded by this script name.
