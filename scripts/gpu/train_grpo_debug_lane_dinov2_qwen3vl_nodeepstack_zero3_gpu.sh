...
# GRPO ZeRO-3 smoke: DINOv2 + Qwen3VL + no DeepStack + lane.
# This mirrors the ZeRO-2 debug script but uses scripts/deepspeed_zero3.json.
...
OUTPUT_DIR="outputs/grpo_debug_lane_dinov2_qwen3vl_nodeepstack_zero3_gpu"
...
echo "============================================================"
echo "GRPO lane ZeRO3 debug: DINOv2 + Qwen3VL + no DeepStack"
