...
class Qwen2MultimodalConfig(Qwen2Config):
    model_type = "qwen2"


class LegacyLlavaQwen2Config(Qwen2MultimodalConfig):
    model_type = "llava_qwen2"


class Qwen2MultimodalModel(LlavaMetaModel, Qwen2Model):
    config_class = Qwen2MultimodalConfig

    def __init__(self, config: Qwen2Config):
        super(Qwen2MultimodalModel, self).__init__(config)


class Qwen2MultimodalForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    config_class = Qwen2MultimodalConfig

    def __init__(self, config):
        super(Qwen2ForCausalLM, self).__init__(config)
        self.model = Qwen2MultimodalModel(config)
...
LlavaConfig = Qwen2MultimodalConfig
LlavaQwen2Model = Qwen2MultimodalModel
LlavaQwen2ForCausalLM = Qwen2MultimodalForCausalLM

AutoConfig.register("llava_qwen2", LegacyLlavaQwen2Config)
AutoModelForCausalLM.register(Qwen2MultimodalConfig, Qwen2MultimodalForCausalLM)
