...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_dinov2_nodeepstack}
SWANLAB_EXPERIMENT_NAME=${SWANLAB_EXPERIMENT_NAME:-sft_phase_a_lane_dinov2_qwen3vl8b_nodeepstack}
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane,dinov2,qwen3vl8b,nodeepstack}
