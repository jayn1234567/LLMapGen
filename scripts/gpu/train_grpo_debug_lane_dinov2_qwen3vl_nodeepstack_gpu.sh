...
# 单卡 GRPO smoke test: DINOv2 + Qwen3VL + no DeepStack + lane.
# 目标是快速验证 GRPO 训练、checkpoint 保存、LoRA checkpoint 推理和中心线评估链路。
...
# ---------- Model paths ----------
# 这里默认使用本机已有的 DINOv2+Qwen3VL debug checkpoint；正式训练时改成你的 SFT checkpoint。
...
OUTPUT_DIR="outputs/grpo_debug_lane_dinov2_qwen3vl_nodeepstack_gpu"
...
echo "============================================================"
echo "GRPO lane debug: DINOv2 + Qwen3VL + no DeepStack"
