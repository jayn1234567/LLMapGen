...
SWANLAB_GROUP=${SWANLAB_GROUP:-sft_phase_a_lane_dinov3_nodeepstack}               # SwanLab group name for related runs.
...
SWANLAB_TAGS=${SWANLAB_TAGS:-sft,phase_a,lane,dinov3,qwen3vl8b,nodeepstack,unimapgen_v9}  # Comma-separated SwanLab tags for filtering runs.
